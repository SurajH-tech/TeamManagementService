...
{
    public class BusinessUnitRequestValidator: AbstractValidator<AddBusinessUnitRequestDTO>
    {
        public BusinessUnitRequestValidator() {
            ...
            RuleForEach(x => x.BusinessCategories).SetValidator(new AddBusinessCategoryValidator());
